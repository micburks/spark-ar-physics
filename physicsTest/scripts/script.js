...
module.exports = {
    ...
    ArrayCollisionMatrix :          __webpack_require__(24),
    ...
    Narrowphase :                   __webpack_require__(26),
    ConeTwistConstraint :           __webpack_require__(42),
    ContactMaterial :               __webpack_require__(29),
    ConvexPolyhedron :              __webpack_require__(8),
    Cylinder :                      __webpack_require__(44),
    DistanceConstraint :            __webpack_require__(45),
    Equation :                      __webpack_require__(11),
    EventTarget :                   __webpack_require__(21),
    FrictionEquation :              __webpack_require__(22),
    GSSolver :                      __webpack_require__(30),
    GridBroadphase :                __webpack_require__(46),
    Heightfield :                   __webpack_require__(47),
    HingeConstraint :               __webpack_require__(31),
    LockConstraint :                __webpack_require__(48),
    Mat3 :                          __webpack_require__(5),
    Material :                      __webpack_require__(13),
    NaiveBroadphase :               __webpack_require__(32),
    ObjectCollisionMatrix :         __webpack_require__(49),
    Pool :                          __webpack_require__(28),
    Particle :                      __webpack_require__(33),
    Plane :                         __webpack_require__(25),
    PointToPointConstraint :        __webpack_require__(19),
    Quaternion :                    __webpack_require__(3),
    Ray :                           __webpack_require__(17),
    RaycastVehicle :                __webpack_require__(50),
    RaycastResult :                 __webpack_require__(14),
    RigidVehicle :                  __webpack_require__(52),
    RotationalEquation :            __webpack_require__(20),
    RotationalMotorEquation :       __webpack_require__(23),
    SAPBroadphase :                 __webpack_require__(53),
    SPHSystem :                     __webpack_require__(54),
    Shape :                         __webpack_require__(2),
    Solver :                        __webpack_require__(18),
    Sphere :                        __webpack_require__(34),
    SplitSolver :                   __webpack_require__(55),
    Spring :                        __webpack_require__(56),
    Transform :                     __webpack_require__(9),
    Trimesh :                       __webpack_require__(57),
    Vec3 :                          __webpack_require__(0),
    Vec3Pool :                      __webpack_require__(27),
    World :                         __webpack_require__(59),
};
...
var Quaternion = __webpack_require__(3);
...
var JacobianElement = __webpack_require__(41),
    Vec3 = __webpack_require__(0);
...
var ContactEquation = __webpack_require__(7);
var FrictionEquation = __webpack_require__(22);
...
var RotationalMotorEquation = __webpack_require__(23);
var ContactEquation = __webpack_require__(7);
var Vec3 = __webpack_require__(0);
...
var Broadphase = __webpack_require__(16);
var AABB = __webpack_require__(4);
...
var Constraint = __webpack_require__(10);
var PointToPointConstraint = __webpack_require__(19);
var ConeEquation = __webpack_require__(43);
var RotationalEquation = __webpack_require__(20);
var ContactEquation = __webpack_require__(7);
var Vec3 = __webpack_require__(0);
...
var RaycastResult = __webpack_require__(14);
var Ray = __webpack_require__(17);
var WheelInfo = __webpack_require__(51);
...
var Body = __webpack_require__(6);
var Sphere = __webpack_require__(34);
var Box = __webpack_require__(15);
var Vec3 = __webpack_require__(0);
var HingeConstraint = __webpack_require__(31);
...
var Vec3 = __webpack_require__(0);
var Quaternion = __webpack_require__(3);
var Particle = __webpack_require__(33);
var Body = __webpack_require__(6);
var Material = __webpack_require__(13);
...
var Transform = __webpack_require__(9);
var AABB = __webpack_require__(4);
var Octree = __webpack_require__(58);
...
var Vec3 = __webpack_require__(0)
var Quaternion = __webpack_require__(3)
var GSSolver = __webpack_require__(30)
var ContactEquation = __webpack_require__(7)
var FrictionEquation = __webpack_require__(22)
var Narrowphase = __webpack_require__(26)
var EventTarget = __webpack_require__(21)
var ArrayCollisionMatrix = __webpack_require__(24)
var OverlapKeeper = __webpack_require__(60)
var Material = __webpack_require__(13)
var ContactMaterial = __webpack_require__(29)
var Body = __webpack_require__(6)
var TupleDictionary = __webpack_require__(61)
var RaycastResult = __webpack_require__(14)
var AABB = __webpack_require__(4)
var Ray = __webpack_require__(17)
var NaiveBroadphase = __webpack_require__(32)
...
class src_CannonHelper {
  constructor(worldObjects) {
    ...
    this.groundMaterial = new Cannon_default.a.Material()

    // pass them in at the beginning?
    this.worldObjects = worldObjects

    // Init our world
    this.world = new Cannon_default.a.World()

    // expose the original cannon object for static methods
    this.CANNON = Cannon_default.a
  ...
  resetBody(cannonBody, pos) {
    ...
    cannonBody.quaternion.setFromAxisAngle(new Cannon_default.a.Vec3(0, 1, 0), 0)
  }
  ...
  static makeBox(size, position, rotation) {
    var mat = new Cannon_default.a.Material()

    return new Cannon_default.a.Body({
      mass: 1,
      position: new Cannon_default.a.Vec3(position.x, position.y, position.z),
      shape: new Cannon_default.a.Box(new Cannon_default.a.Vec3(size.x, size.y, size.z)),
      // if no rotation on W set something, seems to stall if nothing is set!
      quaternion: new Cannon_default.a.Quaternion(rotation.x, rotation.y, rotation.z, rotation.w || 0.5),
  ...
  static makeSphere(size, position, rotation) {
    ...
    return new Cannon_default.a.Body({
      ...
      position: new Cannon_default.a.Vec3(position.x, position.y, position.z),
      shape: new Cannon_default.a.Sphere(size.x),
      material: mat
      // DYNAMIC: 1
      // fixedRotation: true
      // linearDamping: 0.1,
  ...
  static makeFloor(size, position, rotation) {
    ...
    var groundShape = new Cannon_default.a.Plane()
    // const groundShape = new CANNON.Box(new CANNON.Vec3(1000, 1000, 1))
    var groundBody = new Cannon_default.a.Body({
    ...
    groundBody.quaternion.setFromAxisAngle(new Cannon_default.a.Vec3(1, 0, 0), -Math.PI / 2)
...
const console = __webpack_require__(35);
const Instruction = __webpack_require__(36);
const CameraInfo = __webpack_require__(37);
const Scene = __webpack_require__(38);
const Time = __webpack_require__(39);
...
(async () => {
  ...
  const floor = src_CannonHelper.makeFloor();

  // create the world objects
  // world objects contain a scenObject and a physicsObject
  const worldObjects = [{ sceneObject: floorPlane, physicsObject: floor }, {
    sceneObject: cube0,
    physicsObject: src_CannonHelper.makeBox({ x: 5, y: 5, z: 5 }, { x: 0, y: 40, z: 0 }, { x: 0.2, y: 0.8, z: 0, w: 0 })
  }, {
    sceneObject: cube1,
    physicsObject: src_CannonHelper.makeBox({ x: 5, y: 5, z: 5 }, { x: 10, y: 40, z: 0 }, { x: 0.6, y: 0.2, z: 0, w: 0 })
  }, {
    sceneObject: cube2,
    physicsObject: src_CannonHelper.makeBox({ x: 5, y: 5, z: 5 }, { x: 0, y: 30, z: 10 }, { x: 0.1, y: 0.2, z: 0.5, w: 0 })
  }, {
    sceneObject: sphere0,
    physicsObject: src_CannonHelper.makeSphere({ x: 5 }, { x: 0, y: 30, z: 0 }, { x: 0.2, y: 0.5, z: 0, w: 0 })
  }, {
    sceneObject: sphere1,
    physicsObject: src_CannonHelper.makeSphere({ x: 5 }, { x: 15, y: 60, z: 0 }, { x: 0.2, y: 0.5, z: 0, w: 0 })
  }, {
    sceneObject: sphere2,
    physicsObject: src_CannonHelper.makeSphere({ x: 5 }, { x: 0, y: 50, z: 10 }, { x: 0.2, y: 0.5, z: 0, w: 0 })
  }];

  // init the cannon world with the worldObjects
  const cannon = new src_CannonHelper(worldObjects);

  const loopTimeMs = 30;
  let lastTime;
  Time.setInterval(function interval(elapsedTime) {
